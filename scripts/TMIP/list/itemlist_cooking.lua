...
---------------------------2022-2-24新增
	--牛食物
	"beefalotreat",--皮弗娄牛零食
	"beefalotreat_spice_chili",--辣皮弗娄牛零食
	"beefalotreat_spice_garlic",--蒜香皮弗娄牛零食
	"beefalotreat_spice_salt",--咸的皮弗娄牛零食
	"beefalotreat_spice_sugar",--甜皮弗娄牛零食
	"beefalofeed",--蒸树枝
	"beefalofeed_spice_salt",--咸的蒸树枝
	"beefalofeed_spice_garlic",--蒜香蒸树枝
	"beefalofeed_spice_sugar",--甜蒸树枝
	"beefalofeed_spice_chili",--辣蒸树枝
	--肉类料理
	"talleggs",--苏格兰高鸟蛋
	"justeggs",--普通煎蛋
	"veggieomlet",--早餐锅
	...
	"bananajuice_spice_garlic",--蒜香香蕉奶昔
